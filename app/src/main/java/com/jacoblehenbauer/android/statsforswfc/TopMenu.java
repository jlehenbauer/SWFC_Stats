...
public class TopMenu extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button submitCardStatsButton = (Button) findViewById(R.id.submitStatsButton);
        submitCardStatsButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_donate) {
            Intent launchDonate;
            launchDonate = new Intent(this, Donate.class);
            startActivity(launchDonate);
            return true;
        }
